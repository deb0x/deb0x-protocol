...
describe("Test fee claiming for both users and frontends and concurrently stake/unstake", async function() {
    ...
    it("11 ether gathered as fees should be fully distributed back to users", async() => {
        await rewardedAlice["send(address[],string[],address,uint256)"]([messageReceiver.address], ["ipfs://"], feeReceiver.address, 1000, { value: ethers.utils.parseEther("1") })
        await rewardedBob["send(address[],string[],address,uint256)"]([messageReceiver.address], ["ipfs://"], feeReceiver.address, 1000, { value: ethers.utils.parseEther("1") })
        await rewardedBob["send(address[],string[],address,uint256)"]([messageReceiver.address], ["ipfs://"], feeReceiver.address, 1000, { value: ethers.utils.parseEther("1") })
        await rewardedCarol["send(address[],string[],address,uint256)"]([messageReceiver.address], ["ipfs://"], feeReceiver.address, 1000, { value: ethers.utils.parseEther("1") })
        await rewardedCarol["send(address[],string[],address,uint256)"]([messageReceiver.address], ["ipfs://"], feeReceiver.address, 1000, { value: ethers.utils.parseEther("1") })
        await rewardedCarol["send(address[],string[],address,uint256)"]([messageReceiver.address], ["ipfs://"], feeReceiver.address, 1000, { value: ethers.utils.parseEther("1") })
