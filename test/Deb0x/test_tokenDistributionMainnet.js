...
async function test() {
    ...
    console.log(Number(currentCycle))
    console.log(NumUtils.day(currentCycle));
    console.log("CURRENT CYCLE " + await deb0xContract.getCurrentCycle());
    ...
    for (let i = 2; i < currentCycle - 2; i++) {
        ...
        console.log(await deb0xContract.rewardPerCycle(i));
    ...
    console.log("TOTAL FOR ALL CYCLES " + totalRewardUntilCurrentCycle)
    ...
    console.log("TOTAL  DDD  " + totalFrom)
